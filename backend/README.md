...
## Project Structure
    ...
    ├── testapiautocatalog_112290  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112290`
...
2. Clone this repo and `cd testapiautocatalog_112290`
